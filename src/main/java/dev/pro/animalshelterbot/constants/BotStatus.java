...
public enum BotStatus {
    NEW_USER(0L), DEFAULT(1L), CONSULT_NEW_USER(2L), CONSULT_POTENTIAL_OWNER(3L), KEEPING_a_PET(4L),
    CHAT_WITH_VOLUNTEER(5L), AWAITING_GENERAL_WELL_BEING(6L), AWAITING_DIET(7L), AWAITING_CHANGE_IN_BEHAVIOR(8L),
    AWAITING_PHOTO(9L);
